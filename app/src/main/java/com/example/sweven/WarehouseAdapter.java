...
public class WarehouseAdapter extends RecyclerView.Adapter<WarehouseAdapter.ViewHolder> {
    ...
    public WarehouseAdapter(List<ProductItemModel> cartItemsList){
    ...
    @NonNull
    @Override
    public WarehouseAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.retailer_item_layout,viewGroup,false);
        return new WarehouseAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final WarehouseAdapter.ViewHolder viewHolder, int i) {
            ...
            public void onClick(View v) {
                ...
                okBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        firebaseFirestore.collection("WAREHOUSE").document(uid).collection("PRODUCT_INFO").document(productid).set(userdata, SetOptions.merge());
