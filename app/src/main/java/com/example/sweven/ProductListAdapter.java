...
public class ProductListAdapter extends RecyclerView.Adapter<ProductListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ProductListAdapter.ViewHolder viewHolder, int i) {
        final ProductItemModel productitem=productList.get(i);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if(task.isSuccessful()) {
                                    ...
                                    if(!wishlistItemsList.contains(productitem)){
                                        wishlistItemsList.add(productitem);
                                        Toast.makeText(viewHolder.itemView.getContext(),"Product successfuly added to your Wishlist.",Toast.LENGTH_LONG).show();
                                    }else Toast.makeText(viewHolder.itemView.getContext(),"Product already added to your Wishlist.",Toast.LENGTH_LONG).show();
                                }
